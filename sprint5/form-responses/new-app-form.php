...
<head>
    ...
    <script type="text/javascript">
        ...
        if (permissions == "Admin") {
            window.location.replace("/pages/projects/sprint5/pages/admin-admin-dashboard.html");
        } else if (permissions == "User") {
            window.location.replace("/pages/projects/sprint5/pages/user-user-dashboard.html");
            ...
            window.location.replace("/pages/projects/sprint5/index.html");
        }
    </script>
