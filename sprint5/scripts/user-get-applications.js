...
async function getApplications() {
    await fetch("/sprint5/data-processing/get-recent-applications.php")
        .then(response => {
            if (!response.ok) {
...
function updateApplicationsTable(applications) {
    ...
    applications.forEach(application => {
        ...
        const rowData = applicationsTable.row.add([
            ...
            `
                <td>
                    <form method="POST" action="/sprint5/form-responses/user-edit-app-form.php">
            ...
            `
                <td>
                    <form method="POST" action="/sprint5/form-responses/user-soft-delete-application.php">
                        <input type="hidden" name="applicationId" value="${application.applicationsId}">
