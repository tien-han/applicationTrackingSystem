...
if(isset($_POST["email"]) && (!empty($_POST["email"]))){
    ...
    if($error!=""){
        ...
        $message = '<p>Dear user,</p>
                ...
                <br>
                <p><a href = "https://www.cicada.greenriverdev.com/sprint5/data-processing/password-reset.php?key='.$key.'&email='.$email.'">
        https://www.cicada.greenriverdev.com/sprint5/data-processing/password-reset.php?key='.$key.'&email='.$email.'</a></p>
        <br>
