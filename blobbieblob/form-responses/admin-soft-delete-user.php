<head>
    ...
    <script type="text/javascript">
        ...
        if (permissions == "Admin") {
            ...
            window.location.replace("/blobbieblob/pages/admin-dashboard.html");
        } else {
            window.location.replace("/blobbieblob/index.html");
        }
    </script>
    <title>User Soft Deleted</title>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="navbar-toggler">
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../pages/admin-admin-announcement.html">Admin Announcement</a>
                </li>
                <li class="nav-item">
